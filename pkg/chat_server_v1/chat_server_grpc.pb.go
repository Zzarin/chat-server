...
type ChatServerV1Client interface {
	...
	SendMessage(ctx context.Context, in *SendMsgRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *chatServerV1Client) SendMessage(ctx context.Context, in *SendMsgRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ChatServerV1Server interface {
	...
	SendMessage(context.Context, *SendMsgRequest) (*empty.Empty, error)
...
func (UnimplementedChatServerV1Server) SendMessage(context.Context, *SendMsgRequest) (*empty.Empty, error) {
