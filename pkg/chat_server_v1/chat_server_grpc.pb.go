...
type ChatServerV1Client interface {
	...
	SendMessage(ctx context.Context, in *SendMsgRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *chatServerV1Client) SendMessage(ctx context.Context, in *SendMsgRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type ChatServerV1Server interface {
	...
	SendMessage(context.Context, *SendMsgRequest) (*emptypb.Empty, error)
...
func (UnimplementedChatServerV1Server) SendMessage(context.Context, *SendMsgRequest) (*emptypb.Empty, error) {
...
func _ChatServerV1_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServerV1Server).SendMessage(ctx, req.(*SendMsgRequest))
	}
	return interceptor(ctx, in, info, handler)
}
